...
from src.mcqgenerator.MCQGenarator import generate_evaluate_chain
from src.mcqgenerator.logger import logging


# load json
with open('C:/Users/USER/mcqseq/Response.json','r') as file:
    RESPONSE_JSON=json.load(file)

#Creatile app title
st.title("MCQ Creater App with LangChain and OpenAi")   

#Create form using st.form
with st.form("user_inputs"):
    #file_upload 
    uploaded_file=st.file_uploader("Upload a text file or PDF")
        ...
        with st.spinner("loading ....."):
            try:
                ...
                if isinstance(response,dict):
                    #Extrat quiz data from response
